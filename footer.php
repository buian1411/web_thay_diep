                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-3 ec-footer-contact">
                            <div class="ec-footer-widget">
                                <div class="ec-footer-logo"><a href="#"><img src="https://s.pro.vn/KKgc" alt="">
                                        <img class="dark-footer-logo" src="https://s.pro.vn/KKgc" alt="Site Logo"
                                            style="display: none;" /></a></div>
                                <h4 class="ec-footer-heading">Liên hệ với chúng tôi</h4>
                                <div class="ec-footer-links">
                                    <ul class="align-items-center">
                                        <li class="ec-footer-link"><?= $dataStoreCustom['address'] ?>.</li>
                                        <li class="ec-footer-link"><span>Gọi cho chúng tôi:</span><a
                                                href="tel:<?= $dataStoreCustom['phone'] ?>"><?= $dataStoreCustom['phone'] ?></a>
                                        </li>
                                        <li class="ec-footer-link"><span>Email:</span><a
                                                href="mailto:<?= $dataStoreCustom['email'] ?>"><?= $dataStoreCustom['email'] ?></a>
                        ...
                        <div class="col-sm-12 col-lg-3 ec-footer-news">
                            <div class="ec-footer-widget">
                                ...
                                <div class="ec-footer-links">
                                    <ul class="align-items-center">
                                        <li class="ec-footer-link">Nhận thông tin cập nhật tức thì về các sản phẩm mới
                                            của chúng tôi và
                                    ...
                                    <div class="ec-subscribe-form">
                                        <form id="ec-newsletter-form" name="ec-newsletter-form" Method="post"
                                            ...
                                            <div id="ec_news_signup" class="ec-form">
                                                <input class="ec-email" type="email" require=""
                                                    placeholder="Nhập email của bạn vào đây..." name="ec-email"
                                                    value="" />
                                                <button id="ec-news-btn" class="button btn-primary" type="button"
                                                    name="subscribe" value=""><i class="ecicon eci-paper-plane-o" aria-
                                                        ẩn="true"></i></button>
                                            </div>
                                        </form>
                                    </div>
